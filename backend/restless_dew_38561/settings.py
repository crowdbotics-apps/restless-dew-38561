"""
Django settings for restless_dew_38561 project.
...
ROOT_URLCONF = 'restless_dew_38561.urls'
...
WSGI_APPLICATION = 'restless_dew_38561.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "restless_dew_38561 API",
    "DESCRIPTION": "API documentation for restless_dew_38561 App",
    "VERSION": "v1",
}
